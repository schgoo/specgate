...
namespace SpecGateFixtures.Stateful.SharedSetup;
...
public static class SharedSetupOps
{
    ...
    [SpecSetup("combine", Fills = "left")]
    [SpecSetup("combine", Fills = "right")]
    ...
    [SpecSetup("combine_three", Fills = "a")]
    [SpecSetup("combine_three", Fills = "b")]
    [SpecSetup("combine_three", Fills = "c")]
