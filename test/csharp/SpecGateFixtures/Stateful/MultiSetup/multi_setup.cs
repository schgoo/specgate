...
namespace SpecGateFixtures.Stateful.MultiSetup;

/// <summary>An account holding a mutable balance, used as a transfer endpoint.</summary>
...
/// <summary>
/// Multi-setup scenario: two separate setups build the <c>source</c> and
/// <c>target</c> accounts (pinned via <see cref="SpecSetupAttribute.Fills"/>),
/// and <c>transfer</c> mutates both, verifying per-parameter state prefixing.
/// </summary>
